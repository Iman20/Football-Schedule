...
import com.widyatama.iman.footballmatchschedule.presenter.MatchPresenters
...
class LastMatchFragment: Fragment(), MatchInterface{
    private lateinit var presenter: MatchPresenters
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val gson = Gson()
        presenter = MatchPresenters(this, request, gson)
